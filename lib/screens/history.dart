...
class _HistoryPageState extends State<HistoryPage> {
          ...
          child: Column(
            children: [
                        ...
                        child: Column(
                          children: [
                            Container(
                              alignment: Alignment.centerRight,
                              child: Text(
                                '24 Jan 2021', style: Style.bodyText1,),
                            ),
                            Container(
                              padding: EdgeInsets.only(top: 5),
                              alignment: Alignment.centerRight,
                              child: Text(
                                '4:30 PM - 6:00 PM', style: Style.bodyText1,),
                            ),
                          ],
                        ),
                      ),
              ...
              Container(
                ...
                child: Text(
                  'Bangkae, Bangkok', style: Style.HistorySmallTextStyle,),
              ),
              Container(
  ...
  Widget buildShowStat(IconData icon,
      String number,
      String unit,) {
    return Container(
